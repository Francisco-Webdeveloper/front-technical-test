# Prueba técnica para la posición de Frontend Junior

## Objetivo:

Construir un e-commerce responsive usando HTML, CSS y React usando la aplicación NextJS de este proyecto como base. **NO USAR ninguna dependencia adicional.**

El tiempo máximo a dedicar a esta prueba es 2h. No te preocupes si no tienes tiempo de terminar todas las tareas, preferimos calidad antes que cantidad.
